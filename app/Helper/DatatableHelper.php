...
include 'app/Helper/ClassListUtil.php';
class DatatableHelper
{
    /**
     * Definie les colonnes sous formes 'Nom colonne' => true|false
     * @var array
     */
    public array $columnDefault = [];

    public function __construct(array $colonnes)
    {
        $this->columnDefault = $colonnes;
    ...
    public function init()
    {
        ...
        foreach ($allData as $d) {
            $data[] = $this->filterArray($d, $this->columnDefault);
        }
