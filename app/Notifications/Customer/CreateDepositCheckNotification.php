...
class CreateDepositCheckNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->view('emails.customer.create_deposit_check', [
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'text' => 'Votre remise N°'.$this->deposit->reference." à été créer",
    ...
    public function toWebPush($notifiable, $notification)
    {
        return (new WebPushMessage)
            ...
            ->body('Votre remise N°'.$this->deposit->reference." à été créer");
    }
}
