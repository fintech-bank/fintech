    ...
    <div class="d-flex flex-column bg-gray-300 ms-20 me-20 mt-20 mb-5 w-600px rounded">
        ...
        <div class="alert bg-bank d-flex flex-column flex-sm-row p-5 mb-10 mt-10 rounded">
            ...
            <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                <!--begin::Content-->
                <span class="fs-2tx fw-bolder text-start">Nous contrôlons votre identité</span>
                <!--end::Content-->
            </div>
            <!--end::Wrapper-->
        </div>
        ...
        <div class="ms-10 me-10 mb-5">
            ...
            <p>Afin de valider l'ouverture de votre compte bancaire, nous devons procéder à une vérification de votre identité afin de prévenir toutes fraudes potentielles.</p>
            <p>Pour cela, il vous suffit de cliquer sur le bouton ci-dessous.</p>
            <a href="{{ $verify_uri }}" class="btn btn-primary">Vérifier mon identité</a>
        </div>
