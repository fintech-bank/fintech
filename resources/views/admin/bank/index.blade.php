...
@section('toolbar')
    ...
    <div class="page-title d-flex justify-content-center flex-column me-5">
        <!--begin::Title-->
        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Banques</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">Gestion des banques</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <button class="btn btn-bank" data-bs-toggle="modal" data-bs-target="#add_bank"><i class="fa-solid fa-plus"></i> Nouvelle banque</button>
        </div>
    </div>
    <div class="card-body">
        <table id="liste_bank" class="table table-row-bordered gy-5">
            <thead>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-bank">
                <h5 class="modal-title text-white">Nouvelle banque</h5>
            ...
            <form id="formAddBank" action="{{ route('banks.store') }}" method="post" novalidate>
...
@section("script")
    @include("admin.scripts.bank.index")
@endsection
