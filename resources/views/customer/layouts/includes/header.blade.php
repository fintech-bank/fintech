...
<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <a href="{{ route('customer.dashboard') }}">
            <img alt="Logo" src="/storage/logo/logo_long_color.png" class="h-25px h-lg-25px" />
        </a>
        <!--end::Logo-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" style="">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('/assets/media/misc/pattern-1.jpg')">
                            ...
                            <h3 class="text-white fw-bold px-9 mt-10 mb-6">Notifications
                                <span class="fs-8 opacity-75 ps-3">{{ request()->user()->unreadNotifications()->count() }} Notifications non lu</span></h3>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
											    <span class="symbol-label bg-light-{{ $notification->data['color'] }}">
                                                    <i class="fa-solid {{ $notification->data['icon'] }} fa-2x text-{{ $notification->data['color'] }}"></i>
											    </span>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="mb-0 me-2">
                                                ...
                                                <div class="text-gray-400 fs-7">{{ $notification->data['text'] }}</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">{{ $notification->created_at->shortAbsoluteDiffForHumans() }}</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    @endforeach
