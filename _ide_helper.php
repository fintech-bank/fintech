...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function scan($imagePath)
        {
                        /** @var \Alimranahmed\LaraOCR\Services\Tesseract $instance */
                        return $instance->scan($imagePath);
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Alimranahmed\LaraOCR\Services\OcrAbstract         
                        /** @var \Alimranahmed\LaraOCR\Services\Tesseract $instance */
                        return $instance->setImagePath($imagePath);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * 
         *
         * @see \Studio\Totem\Providers\TotemFormServiceProvider::boot()
         * @param string $label
